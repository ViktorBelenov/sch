...
const days = [{"date":"22.04.2024","day":"пятница"},
			  {"date":"23.04.2024","day":"суббота"},
			  {"date":"24.04.2024","day":"воскресенье"}];
var treks = [];
var trekTab = '';
...
function genDayTab(obj,i) {
	if (i) {
		$('#tabs-dates').append('<div class=\"programm__subtabs__item-date\" onclick=\"toDateTab(\'' + obj.date.replace(/[.]/gi,'-') + '\');\"><a id=\"tabs-dates-' + obj.date.replace(/[.]/gi,'-') + '\" class=\"\">' + obj.date + ' – ' + obj.day + '</a></div>');
	} else {
